...
Kasino ohjelmani on komentorivillä toimiva kasinopeli pythonilla.
Kasinossa on muutama erilainen pelivaihtoehto joita käyttäjä voi pelata. 
Pelit ovat:
- 🎡 Ruletti
- 🗼 Tower
- 🪙 Coinflip
...
1. Varmista että Python on asennettuna
2. Lataa tiedosto Kasino.py
3. Aja komennolla: python Kasino.py
